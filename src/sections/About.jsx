    ...
    <section className="c-space section-spacing">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Quayyum.</p>
            <p className="subtext">
              Over the last 1 year, I have been able to significantly improve my
              software engineering skills in both frontend and backend
              development through rigorous training and hands-on experience. I
              have honed my skills to deliver dynamic and scalable software and
              web applications.
            </p>
          </div>
